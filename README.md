...
Attached in this repository are the following: A raw Aviation Data csv file; a cleaned Aviation Data csv file; a jupyter notebook containing code on the data cleaning process, an Exploratory Data Analysis (EDA), and preliminary conclusions and recommendations; a tableau file containing sheets and a dashboard; and a powerpoint presentation summarizing my research.
